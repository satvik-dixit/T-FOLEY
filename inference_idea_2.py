...
def save_samples(gen_audio_1, gen_audio_2, combined_target, output_dir, sr, class_name_1, class_name_2, alpha):
...
def main(args):
    ...
    save_samples(gen_audio_1, gen_audio_2, combined_target, args.output_dir, sample_rate, args.class_name_1, args.class_name_2, args.alpha)
    print('Done!')
